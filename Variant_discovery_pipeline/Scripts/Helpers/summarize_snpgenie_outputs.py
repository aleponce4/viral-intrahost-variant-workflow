...
def main() -> None:
    ...
    parser.add_argument("--output-dir", required=True, help="SNPGenie output folder (contains thresholds/samples)")
    parser.add_argument("--summary-dir", required=True, help="Output folder to save merged summaries")
