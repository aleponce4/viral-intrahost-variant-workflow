...
MANDATORY_FILES=(
    ...
    "modules/local/bwa/index/main.nf"
    "modules/local/bwa/mem/main.nf"
    "modules/local/ivar/trim/main.nf"
    "modules/local/samtools/stats/main.nf"
    ...
    "modules/local/dumpsoftwareversions/main.nf"
    "modules/local/multiqc/main.nf"
    "modules/local/report/executive_report/main.nf"
    "subworkflows/input_check/main.nf"
    "subworkflows/local/read_preprocessing.nf"
    "subworkflows/local/selection.nf"
    "subworkflows/local/haplotype.nf"
    ...
    "tests/subworkflows/read_preprocessing/main.nf.test"
